...
Player = function (param) {
	...
	self.updateSpd = function () {
		...
		self.attackInterval++; //enable attack bar when moving bc idk how to do timers lol
...
Enemy.getAllInitPack = function () {
	...
	for (var i in Enemy.list)
		enemy.push(Enemy.list[i].getInitPack());
	return enemy;
}
...
Bullet = function (param) {
	...
	self.spdX = Math.cos(param.angle / 180 * Math.PI) * 50; //Bullet speed
